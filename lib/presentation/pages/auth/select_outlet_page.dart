  ...
  Future<void> _submitSelection() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Gagal menyimpan outlet. Coba lagi.')),
      );
    } finally {
      if (mounted) {
        setState(() {
        ...
        child: Column(
          children: [
            Expanded(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Pilih outlet restoran untuk melanjutkan',
            ...
            Container(
              ...
              child: FilledButton(
                onPressed: _selectedOutlet == null || _isSubmitting
                    ? null
                    : _submitSelection,
